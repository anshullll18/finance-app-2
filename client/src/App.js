...
function App() {
  ...
  const [formData, setFormData] = useState({
    email: '', password: '', name: '', type: 'expense', amount: '', category: '', description: ''
  });
  ...
  const pieData = Object.entries(stats.categoryStats || {}).map(([name, value]) => ({ name, value }));
        ...
        <div className="transactions-section">
          <div className="section-header">
            ...
            <div>
              ...
              <button onClick={handleExportCSV} style={{ marginLeft: '10px' }}>Export CSV</button>
            </div>
          </div>
